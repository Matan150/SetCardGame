...
public class Dealer implements Runnable {
    ...
    private void updateTimerDisplay(boolean reset) { 
        ...
        env.ui.setCountdown(Math.max(reshuffleTime - System.currentTimeMillis(), 0), reshuffleTime - System.currentTimeMillis() < env.config.endGamePauseMillies);
   }
     ...
     */
    private void announceWinners() { //TODO: need to implement
